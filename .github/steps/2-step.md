...
1. When the workflow succeeds, you should see the uploaded Playwright report artifact (`index.html`) in the workflow summary page:
   ...
   <img width="900" alt="Workflow summary page showing the uploaded artifact" src="https://github.com/pat91182/friendly-chainsaw/blob/main/.github/images/tests-playwright-report-artifact.png?raw=true" />

1. Click on the artifact to open the Playwright report directly in the browser.

   <img width="900" alt="Playwright report opened directly in the browser from the artifact page" src="https://github.com/pat91182/friendly-chainsaw/blob/main/.github/images/playwright-report.png?raw=true" />
